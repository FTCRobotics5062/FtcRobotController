...
//            arm.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
    ...
    private DriveEncoderArm.DriveDir getDir(double dir) {
        if (dir <= -0.7) {
            return DriveEncoderArm.DriveDir.HARD_LEFT;
        } else if (dir <= -0.4) {
            return DriveEncoderArm.DriveDir.MEDIUM_LEFT;
        } else if (dir <= -0.1) {
            return DriveEncoderArm.DriveDir.EASY_LEFT;
        } else if (dir >= 0.7) {
            return DriveEncoderArm.DriveDir.HARD_RIGHT;
        } else if (dir >= 0.4) {
            return DriveEncoderArm.DriveDir.MEDIUM_RIGHT;
        } else if (dir >= 0.1) {
            return DriveEncoderArm.DriveDir.EASY_RIGHT;
        } else {
            return DriveEncoderArm.DriveDir.STRAIGHT;
        }
    }
